...
$( document ).ready(function() {
    ...
    form += " <input type='submit' value='submit' > <input type='button' name='show' id='showBtn' value='اظهر الاستمارات ' >  <a href='../php/input.php?hello=true'>Add new specified in DB input field!</a></form>";
